# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/99-join-utils.ipynb.

# %% auto 0
__all__ = ['excluded_words', 'get_synset', 'get_food_hypernyms', 'flatten_list', 'clean_word', 'clean_alt_words',
           'find_alt_words']

# %% ../notebooks/99-join-utils.ipynb 2
from nltk.corpus import wordnet
import warnings
from .utils import *

# %% ../notebooks/99-join-utils.ipynb 4
...
# %% ../notebooks/99-join-utils.ipynb 7
excluded_words = [
    'cut'
]

# %% ../notebooks/99-join-utils.ipynb 9
